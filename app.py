            ...
            <div class="grid grid-cols-2 gap-8">
                <div class="bg-slate-800 p-6 rounded-xl">
                    ...
                    <form method="post" action="/add" class="space-y-4">
                        <input name="name" placeholder="Name" class="w-full p-3 rounded bg-slate-700" required>
                        <input name="amount" type="number" placeholder="Amount" class="w-full p-3 rounded bg-slate-700" required>
                        <input name="category" placeholder="Category" class="w-full p-3 rounded bg-slate-700" required>
                        <button class="w-full py-3 bg-green-500 rounded">Add Expense</button>
                    </form>
                </div>
